...
quirks = {
    ...
    "main13_spine_luciya/main13_spine_luciya": {
        "all_scale": 0.5,
        "all_position": (0, -2),
    },
    ...
    "2-11spine/lamiyaskin/lamiyaskinautowindow": {
        "all_scale": 0.45,
        "size": (1518, 856),
    },
...
quirks_glue = {
    "selena/selenaactivity/selenaactivitybg": GlueQuirk(
        "selena/selenaactivity",
        [
            "selena/selenaactivity/selenaactivitybg",
            "selena/selenaactivity/selenaactivityqg",
        ],
    ),
    "activityspine/activityspineyuandan/activityspineyuandanbg": GlueQuirk(
        "activityspine/activityspineyuandan",
        [
            "activityspine/activityspineyuandan/activityspineyuandanbg",
            "activityspine/activityspineyuandan/activityspineyuandanqg",
        ],
    ),
    "activityspine/activityspinechunjieqishi/activityqishibg": GlueQuirk(
        "activityspine/activityspinechunjieqishi",
        [
            "activityspine/activityspinechunjieqishi/activityqishibg",
            "activityspine/activityspinechunjieqishi/activityqishirole",
            "activityspine/activityspinechunjieqishi/activityqishiqg",
        ],
    ),
    "activityspine/activityhakama/activityhakamabg": GlueQuirk(
        "activityspine/activityhakama",
        [
            "activityspine/activityhakama/activityhakamabg",
            "activityspine/activityhakama/activityhakamaqg",
        ],
    ),
}
...
quirks_skip = set(
    layer
    for quirk in quirks_glue.values()
    for layer in quirk.layers
    if layer not in quirks_glue
)
